...
export default function Header() {
  ...
  return (
    <div className={`invisible ${showPage ? "!visible" : ""}`}>
      <div className="flex absolute z-[33] top-0 left-0 w-full items-center justify-between px-[40px] py-5  box-border text-[20px] font-formula">
        <Link
